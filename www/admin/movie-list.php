...
$page->smarty->assign('pagerquerybase', WWW_TOP."/movie-list.php?".$tsearch."&offset=");
$pager = $page->smarty->fetch("pager.tpl");
$page->smarty->assign('pager', $pager);

$movielist = $movie->getRange($offset, ITEMS_PER_PAGE, $tname);
