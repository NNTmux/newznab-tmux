...
<tr>
	...
	<td>
		<input id="newznabID" class="long" name="newznabID" type="text" value="{$site->newznabID}" />
...
<tr>
	...
	<td>
		<input class="long" id="latestregexurl" name="latestregexurl" type="text" value="{$site->latestregexurl}" />
