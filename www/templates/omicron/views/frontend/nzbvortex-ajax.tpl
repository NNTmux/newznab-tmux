			...
			<div class="vortex-nzb" style="padding: 5px 0 5px 0">
				...
				<div style="width: 20px; float: left; margin: 7px 0 0 0">
					{if $nzb['isPaused'] eq 1}
						<img src="{$smarty.const.WWW_TOP}/templates_shared/images/icons/vortex/blah.png"
							 style="float: left; margin: 0 5px 0 0"/>
					{else}
						<img src="{$smarty.const.WWW_TOP}/templates_shared/images/icons/vortex/bigsmile.png"
							 style="float: left; margin: 0 5px 0 0"/>
					{/if}
				</div>
					...
					<div style="border-right: 2px solid #eee; width: 41px; float: left; margin: 0 5px 0 0">
						{if $nzb['isPaused'] eq 1}
							<a class="vortex-resume" title="Resume" href="{$nzb['id']}"><img
										src="{$smarty.const.WWW_TOP}/templates_shared/images/icons/vortex/play.png"/></a>
						{else}
							<a class="vortex-pause" title="Pause" href="{$nzb['id']}"><img
										src="{$smarty.const.WWW_TOP}/templates_shared/images/icons/vortex/pause.png"/></a>
						{/if}
						<a class="vortex-filelist" title="View filelist" href="{$nzb['id']}"><img
									src="{$smarty.const.WWW_TOP}/templates_shared/images/icons/vortex/tv.png"/></a>
					</div>
					<div class="vortex-controls" style="float: left">
						<a class="vortex-moveup" title="Move up in queue" href="{$nzb['id']}"><img
									src="{$smarty.const.WWW_TOP}/templates_shared/images/icons/vortex/arrow2_n.png"/></a>
						<a class="vortex-movedown" title="Move down in queue" href="{$nzb['id']}"><img
									src="{$smarty.const.WWW_TOP}/templates_shared/images/icons/vortex/arrow2_s.png"/></a>
						<a class="vortex-movebottom" title="Move to bottom of queue" href="{$nzb['id']}"><img
									src="{$smarty.const.WWW_TOP}/templates_shared/images/icons/vortex/arrow3_s.png"/></a>
						<a class="vortex-movetop" title="Move to top of queue" href="{$nzb['id']}"><img
									src="{$smarty.const.WWW_TOP}/templates_shared/images/icons/vortex/arrow3_n.png"/></a>
						<a class="vortex-trash" title="Cancel and delete NZB" href="{$nzb['id']}"><img
									src="{$smarty.const.WWW_TOP}/templates_shared/images/icons/vortex/trash.png"/></a>
					</div>
					<br style="clear: both"/>
				</div>
			</div>
