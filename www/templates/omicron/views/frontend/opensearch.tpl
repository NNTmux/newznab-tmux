<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/"
	...
	<Image width="16" height="16">{$serverroot}templates/omicron/images/favicon.ico</Image>
	...
	<moz:IconUpdateUrl>{$serverroot}templates/omicron/images/favicon.ico</moz:IconUpdateUrl>
