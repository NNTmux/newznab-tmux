...
<script type="text/javascript" src="{$smarty.const.WWW_TOP}/templates/charisma/scripts/autosize-min.js"></script>
...
<script type="text/javascript" src="{$smarty.const.WWW_TOP}/templates/charisma/js/bootstrap-spacelab.js"></script>

<!-- Pines Notify -->
<script type="text/javascript" src="{$smarty.const.WWW_TOP}/templates/charisma/scripts/pnotify.custom.min.js"></script>
<link href="{$smarty.const.WWW_TOP}/templates/charisma/scripts/pnotify.custom.min.js}" media="all" rel="stylesheet"
	  type="text/css"/>

<!-- Modernizr -->
<script type="text/javascript"
		src="{$smarty.const.WWW_TOP}/templates/charisma/scripts/modernizr.custom.44570.js"></script>
</body>
</html>