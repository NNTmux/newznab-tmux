							...
							<div class="btns" style="float:right">
								...
								{if $result.passwordstatus == 1}
									<img title="RAR/ZIP Possibly Passworded."
										 src="{$smarty.const.WWW_TOP}/templates/charisma/images/icons/lock2.png"
										 alt="RAR/ZIP Possibly Passworded.">
								{elseif $result.passwordstatus == 2}
									<img title="RAR/ZIP Possibly Damaged."
										 src="{$smarty.const.WWW_TOP}/templates/charisma/images/icons/broken.png"
										 alt="RAR/ZIP Possibly Damaged.">
								{elseif $result.passwordstatus == 10}
									<img title="RAR/ZIP is Passworded."
										 src="{$smarty.const.WWW_TOP}/templates/charisma/images/icons/lock.gif"
					...
					<td class="files">
						...
						{if $result.rarinnerfilecount > 0}
							<div class="rarfilelist">
								<img src="{$smarty.const.WWW_TOP}/templates/charisma/images/icons/magnifier.png"
									 alt="{$result.guid}">
							</div>
						{/if}
					</td>
