				...
				<div class="col-xlg-12 portlets">
					<div class="panel">
						<div class="panel-content pagination2">
							...
							{/if}
							<a class="label label-default"
							   href="http://www.google.com/search?q={$release.name|escape:"htmlall"}" target="_blank">Google</a>
														...
														<div class="col-md-3 no-gutter">
															{if $movie && $release.rageid < 0 && $movie.cover == 1}
																<img src="{$smarty.const.WWW_TOP}/covers/movies/{$movie.imdbid}-cover.jpg"
																	 width="185" alt="{$movie.title|escape:"htmlall"}"
															...
															{if $anidb && $release.anidbid > 0 && $anidb.picture != ""}
																<img src="{$smarty.const.WWW_TOP}/covers/anime/{$anidb.anidbid}.jpg"
																	 width="185" alt="{$anidb.title|escape:"htmlall"}"
																	 data-toggle="modal" data-target="#modal-image"/>
															{/if}
															{if $con && $con.cover == 1}
																<img src="{$smarty.const.WWW_TOP}/covers/console/{$con.id}.jpg"
																	 width="185" alt="{$con.title|escape:"htmlall"}"
																	 data-toggle="modal" data-target="#modal-image"/>
															{/if}
															...
															{if $music && $music.cover == 1}
																<img src="{$smarty.const.WWW_TOP}/covers/music/{$music.id}.jpg"
																	 width="185" alt="{$music.title|escape:"htmlall"}"
																	 data-toggle="modal" data-target="#modal-image"/>
															{/if}
															{if $book && $book.cover == 1}
																<img src="{$smarty.const.WWW_TOP}/covers/book/{$book.id}.jpg"
																	 width="185" alt="{$book.title|escape:"htmlall"}"
																	 data-toggle="modal" data-target="#modal-image"/>
															{/if}
															{if $xxx && $xxx.cover == 1}
															...
															<div class="btn-group btn-group-vertical">
																...
																{if $weHasVortex}
																	...
																	<i class="icon_sab fa fa-arrow-right"
																	   id="guid{$release.guid}"></i> Send to NZBVortex
																	</button>{/if}
																<p id="demo"></p>
															</div>
														</div>
																...
																<tr valign="top">
																	<td>
																		<table class="table table-condensed table-striped responsive">
																			...
																			<tr>
																				<th width="140">Size / Completion</th>
													...
													{if $comments|@count > 0}
														<table class="table table-striped">
															...
															{foreach from=$comments item=comment}
																<tr>
																	<td width="150">{if $comment.sourceid == 0}<a
																	...
																	<br/>
																		<span style="color: #ce0000;">(syndicated)</span>{/if}
