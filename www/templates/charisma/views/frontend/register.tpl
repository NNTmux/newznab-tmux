...
<head>
	...
	<link href='{$smarty.const.WWW_TOP}/templates/charisma/bower_components/fullcalendar/dist/fullcalendar.css'
		  rel='stylesheet'>
	<link href='{$smarty.const.WWW_TOP}/templates/charisma/bower_components/fullcalendar/dist/fullcalendar.print.css'
	...
	<link href='{$smarty.const.WWW_TOP}/templates/charisma/bower_components/bootstrap-tour/build/css/bootstrap-tour.min.css'
		  rel='stylesheet'>
	<link href='{$smarty.const.WWW_TOP}/templates/charisma/css/jquery.noty.css' rel='stylesheet'>
	<link href='{$smarty.const.WWW_TOP}/templates/charisma/css/noty_theme_default.css' rel='stylesheet'>
...
<!-- calender plugin -->
<script src='{$smarty.const.WWW_TOP}/templates/charisma/bower_components/moment/min/moment.min.js'></script>
...
<script src="{$smarty.const.WWW_TOP}/templates/charisma/bower_components/colorbox/jquery.colorbox-min.js"></script>
<!-- notification plugin -->
<script src="{$smarty.const.WWW_TOP}/templates/charisma/js/jquery.noty.js"></script>
<!-- library for making tables responsive -->
<script src="{$smarty.const.WWW_TOP}/templates/charisma/bower_components/responsive-tables/responsive-tables.js"></script>
<!-- tour plugin -->
<script src="{$smarty.const.WWW_TOP}/templates/charisma/bower_components/bootstrap-tour/build/js/bootstrap-tour.min.js"></script>
<!-- star rating plugin -->
<script src="{$smarty.const.WWW_TOP}/templates/charisma/js/jquery.raty.min.js"></script>
<!-- for iOS style toggle switch -->
<script src="{$smarty.const.WWW_TOP}/templates/charisma/js/jquery.iphone.toggle.js"></script>
<!-- autogrowing textarea plugin -->
<script src="{$smarty.const.WWW_TOP}/templates/charisma/js/jquery.autogrow-textarea.js"></script>
<!-- multiple file upload plugin -->
<script src="{$smarty.const.WWW_TOP}/templates/charisma/js/jquery.uploadify-3.1.min.js"></script>
