			...
			<table style="width:100%;" class="data highlight icons" id="browsetable">
				<tr>
					...
					<th>name<br/><a title="Sort Descending" href="{$orderbyname_desc}"><img
									...
									src="{$smarty.const.WWW_TOP}/themes/nntmux/images/sorting/arrow_up.gif"
					...
					<tr class="{cycle values=",alt"}" id="guid{$mguid[$m@index]}">
						...
						<td class="item">
							<label for="chk{$mguid[$m@index]|substr:0:7}"><a class="title" title="View details"
																			 href="{$smarty.const.WWW_TOP}/details/{$mguid[$m@index]}">{$mname[$m@index]|escape:"htmlall"|replace:".":" "}</a></label>

							{if $mpass[$m@index] == 2}
								<img title="Passworded Rar Archive"
									 src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/lock.gif"
						...
						<td class="less mid">
							...
							{if $minnerfiles[$m@index] > 0}
								<div class="rarfilelist">
									<img src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/magnifier.png"
