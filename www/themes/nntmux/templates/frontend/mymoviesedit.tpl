		...
		{foreach from=$movies item=movie}
			<tr class="{cycle values=",alt"}">
				...
				<td class="mid">
					...
					<div class="movcover">
						<img class="shadow" src="{$smarty.const.WWW_TOP}/covers/movies/{if $movie.cover == 1}{$movie.imdbid}-cover.jpg{else}{$smarty.const.WWW_TOP}themes_shared/images/no-cover.png{/if}" width="120" border="0" alt="{$movie.title|escape:"htmlall"}" />
						<div class="movextra">
