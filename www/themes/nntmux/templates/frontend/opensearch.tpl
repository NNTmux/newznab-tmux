<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/" xmlns:moz="http://www.mozilla.org/2006/browser/search/">
	...
	<Image width="16" height="16">{$smarty.const.WWW_TOP}themes/nntmux/images/favicon.ico</Image>
	...
	<moz:IconUpdateUrl>{$smarty.const.WWW_TOP}themes/nntmux/images/favicon.ico</moz:IconUpdateUrl>
