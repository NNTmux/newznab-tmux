	...
	<table style="width:100%;" class="data highlight icons" id="coverstable">
		<tr>
			...
			<th>title<br/><a title="Sort Descending" href="{$orderbytitle_desc}"><img
							src="{$smarty.const.WWW_TOP}/themes/nntmux/images/sorting/arrow_down.gif" alt=""/></a><a
						title="Sort Ascending" href="{$orderbytitle_asc}"><img
							src="{$smarty.const.WWW_TOP}/themes/nntmux/images/sorting/arrow_up.gif" alt=""/></a></th>
					...
					<div class="movcover">
						...
						<div class="movextra">
							...
							<a
									...
									><img src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/trakt.png"></a>
							{if $cpurl != '' && $cpapi != ''}
								<a
										class="sendtocouch"
										target="blackhole"
										...
										><img src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/couch.png"></a>
							{/if}
							<a
									target="_blank"
									href="{$site->dereferrer_link}http://www.imdb.com/title/tt{$result.imdbid}/"
									name="imdb{$result.imdbid}"
									title="View imdb page"><img src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/imdb.png"></a>
							<a
									target="_blank"
									href="{$site->dereferrer_link}http://www.rottentomatoes.com/m/{$result.title|replace:" ":"_"}/"
									name="rottentomatoes{$result.title|replace:" ":"_"}}"
									title="View RT page"><img src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/rottentomatoes.png"></a>
						</div>
					</div>
				</td>
								...
								<tr id="guid{$mguid[$m@index]}" {if $m@index > 1}class="mlextra"{/if}>
									...
									<td class="icons">
										<div class="icon icon_nzb"><a title="Download Nzb"
																	  href="{$smarty.const.WWW_TOP}/getnzb/{$mguid[$m@index]}|escape:"url"}">
												&nbsp;</a></div>
