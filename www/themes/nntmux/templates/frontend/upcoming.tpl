							...
							{if $result->ratings->critics_score > 60}
								<a
										...
										title="View Rotten Tomatoes Details"><img
											src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/fresh.png"></a>
							{else}
								<a
										target="_blank"
										href="{$site->dereferrer_link}{$result->links->alternate}"
										title="View Rotten Tomatoes Details"><img
											src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/rotten.png"></a>
							{/if}
							<a
									target="_blank"
									...
									title="View imdb page"><img
										src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/imdb.png"></a>
							<a
									target="_blank"
									...
									title="View trakt page"><img
										src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/trakt.png"></a>
							{if $cpurl != '' && $cpapi != ''}
								<a
										class="sendtocouch"
										target="blackhole"
										...
										name="CP{$result->alternate_ids->imdb}" title="Add to CouchPotato"><img
											src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/couch.png">
								</a>
							{/if}
						</div>
					</div>
