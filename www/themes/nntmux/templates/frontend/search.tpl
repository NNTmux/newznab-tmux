			...
			<tr>
				...
				<th>
					...
					<a title="Sort Descending" href="{$orderbyname_desc}">
						<img src="{$smarty.const.WWW_TOP}/themes/nntmux/images/sorting/arrow_down.gif" alt="Sort Descending">
					</a>
					<a title="Sort Ascending" href="{$orderbyname_asc}">
						<img src="{$smarty.const.WWW_TOP}/themes/nntmux/images/sorting/arrow_up.gif" alt="Sort Ascending">
					</a>
				</th>
						...
						<div class="resextra">
							...
							<div class="btns" style="float:right">
								...
								{if $result.passwordstatus == 1}
									<img title="RAR/ZIP Possibly Passworded." src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/lock2.png" alt="RAR/ZIP Possibly Passworded.">
								{elseif $result.passwordstatus == 2}
									<img title="RAR/ZIP Possibly Damaged." src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/broken.png" alt="RAR/ZIP Possibly Damaged.">
								{elseif $result.passwordstatus == 10}
									<img title="RAR/ZIP is Passworded." src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/lock.gif" alt="RAR/ZIP is Passworded.">
								{/if}
					...
					<td class="files">
						...
						{if $result.rarinnerfilecount > 0}
							<div class="rarfilelist">
								<img src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/magnifier.png" alt="{$result.guid}">
							</div>
						{/if}
					</td>
