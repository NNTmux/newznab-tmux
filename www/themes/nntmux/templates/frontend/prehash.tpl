...
{foreach from=$results item=result}
	...
	<td class="prehash" style="text-align:center;">
		...
		{if {$result.category} == 'XBOX360'}
			<a class="title" title="View category XBOX 360" href="{$smarty.const.WWW_TOP}/browse?t=1050">Console Xbox
				360</a>
			{* Movies *}
	...
	<td class="prehash" style="text-align:center;">
		...
		{elseif {$result.source} == prelist}
			<a title="Visit Prelist" href="{$site->dereferrer_link}http://www.prelist.ws/?search={$result.title}"
			   target="_blank">
				Prelist
			</a>
		...
		{elseif {$result.source} == "usenet-crawler"}
			<a title="Visit Usenet-Crawler"
			   href="{$site->dereferrer_link}http://www.usenet-crawler.com/predb?q={$result.title}" target="_blank">
				Usenet-Crawler
			</a>
	...
	<td class="prehash" style="text-align:center;">
		<a
				...
				target="_blank"
				>
			<img src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/nzbindex.png"/>
			&nbsp;
		</a>
	</td>
	<td class="prehash" style="text-align:center;">
		<a
				...
				target="_blank"
				>
			<img src="{$smarty.const.WWW_TOP}/themes/nntmux/images/icons/binsearch.png"/>
			&nbsp;
		</a>
	</td>
	</tr>
