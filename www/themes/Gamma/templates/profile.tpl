	...
	<tr>
		...
		<td>
			...
			<div style="display:none; margin-top:20px;" id="divInvite">
				<div class="invitesuccess alert alert-success" id="divInviteSuccess"><strong>Invite Sent</strong><br/></div>
				<div class="invitefailed alert alert-error" id="divInviteError"></div>
