{if $results|@count > 0}
	{foreach $results as $result}
		<div id="moviefull" style="min-height:340px;">
			{if $result.cover eq 1}<img class="shadow pic img-polaroid pull-right" width="200px" alt="{$result.title|escape:"htmlall"} Logo" src="{$smarty.const.WWW_TOP}/covers/movies/{$result.imdbid}-cover.jpg" />{/if}
