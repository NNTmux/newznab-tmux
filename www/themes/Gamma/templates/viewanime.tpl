				...
				<tr class="{cycle values=",alt"}" id="guid{$result.guid}">
					...
					<div class="resextra">
						<div class="btns">
							...
							{if $result.haspreview eq 1 && $userdata.canpreview eq 1}<a href="{$smarty.const.WWW_TOP}/covers/preview/{$result.guid}_thumb.jpg" name="name{$mguid[$m@index]}" title="Screenshot" class="modal_prev rndbtn badge" rel="preview">Preview</a>{/if}
