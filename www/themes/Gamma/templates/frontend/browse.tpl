	...
	<table style="100%" class="data highlight icons table table-striped Sortable" id="browsetable">
		...
		<tr class="{cycle values=",alt"}{if $lastvisit|strtotime<$result.adddate|strtotime} new{/if}" id="guid{$result.guid}">
			...
			<td class="item">
				...
				&nbsp;<img title="{$result.nuketype}" src="{$smarty.const.WWW_THEMES}/{$theme}/images/icons/nuke.png" width="10" height="10" alt="{$result.nuketype}" />
				{/if}
				<div class="resextra">
			...
			<td class="less mid">
				...
				<div class="rarfilelist">
					<img src="{$smarty.const.WWW_THEMES}/{$theme}/images/icons/magnifier.png" alt="{$result.guid}" class="tooltip" />
				</div>
				{/if}
			</td>
