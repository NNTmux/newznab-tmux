<div class="well well-sm">
	...
	{if $error == ''}
	{if $page->getSettingValue('..sabintegrationtype') > 0 || $user.queuetype == 2}
	<p style="text-align:center;">
		The following queue is pulled from
		<a href="{$serverURL|escape:"htmlall"}">{$serverURL|escape:"htmlall"}</a>.
		<br/>
		{if $page->getSettingValue('..sabintegrationtype') == 2 || $user.queuetype == 2}Edit your queue settings in
