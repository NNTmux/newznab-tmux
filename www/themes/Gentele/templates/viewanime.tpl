								...
								<tr class="{cycle values=",alt"}" id="guid{$result.guid}">
										...
										<div>
											<div>
												{if $result.nfoid > 0}<span><a
															...
															class="modal_nfo label label-primary text-muted">NFO</a></span>{/if}
									...
									<td class="icon_nzb"><a
												href="{$smarty.const.WWW_TOP}/getnzb/{$result.guid}"><i
													class="fa fa-cloud-download text-muted" data-toggle="tooltip" data-placement="top" title data-original-title="Download NZB"></i></a>
										<a href="{$smarty.const.WWW_TOP}/details/{$result.guid}/#comments"><i
													class="fa fa-comments-o text-muted" data-toggle="tooltip" data-placement="top" title data-original-title="Comments"></i></a>
										...
										{if isset($sabintegrated) && $sabintegrated !=""}
											<a href="#" class="icon_sab text-muted"><i class="fa fa-share"
																					   data-toggle="tooltip" data-placement="top" title data-original-title="Send to My Queue"></i></a>
										{/if}
										{if $weHasVortex}
