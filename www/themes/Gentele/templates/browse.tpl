				...
				<div class="col-md-12 col-xs-12">
					<div class="panel panel-default">
						<div class="panel-body pagination2">
							...
							<div class="container">
								<div class="row">
									<div class="col-md-12 col-lg-12 col-sm-6 col-xs-3"
									<table class="table table-striped table-responsive jambo-table bulk-action">
										<thead>
										<tr class="headings">
											...
											<th class="column-title no-link last" style="display: table-cell;">Action
											</th>
