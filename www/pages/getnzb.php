...
if ($page->users->isLoggedIn()) {
	...
	if ($page->getSettingValue('..registerstatus') == Settings::REGISTER_STATUS_API_ONLY) {
...
//
$hosthash = "";
if ($page->getSettingValue('..storeuserips') == 1) {
	$hosthash = $page->users->getHostHash($_SERVER["REMOTE_ADDR"], $page->getSettingValue('..siteseed'));
}
