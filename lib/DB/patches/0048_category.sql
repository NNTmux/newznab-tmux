...
INSERT INTO category (ID, title, parentID) VALUES (7010, 'Ebook', 7000);
INSERT INTO category (ID, title, parentID) VALUES (7020, 'Comics', 7000);
INSERT INTO category (ID, title, parentID) VALUES (7030, 'Magazines', 7000);
...
UPDATE `tmux` SET `value` = '48' WHERE `setting` = 'sqlpatch';