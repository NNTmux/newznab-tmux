...
<body>
	...
	<div class="content">
		...
		<div class="footer">
			<p><br /><a href="https://www.newznab.com/">newznab</a>+ is distributed with a commercial licence. See LICENCE.txt for further details. All rights reserved <?php echo date("Y"); ?>.</p>
		</div>
	</div>
</body>
</html>
