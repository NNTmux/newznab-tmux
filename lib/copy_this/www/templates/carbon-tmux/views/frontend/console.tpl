...
<table style="width:100%;" class="data highlight icons" id="coverstable">
	<tr>
		...
		<th>title<br/><a title="Sort Descending" href="{$orderbytitle_desc}"><img src="{$smarty.const.WWW_TOP}/templates/carbon-tmux/images/sorting/arrow_down.gif" alt="" /></a><a title="Sort Ascending" href="{$orderbytitle_asc}"><img src="{$smarty.const.WWW_TOP}/templates/carbon-tmux/images/sorting/arrow_up.gif" alt="" /></a></th>
		<th>platform<br/><a title="Sort Descending" href="{$orderbyplatform_desc}"><img src="{$smarty.const.WWW_TOP}/templates/carbon-tmux/images/sorting/arrow_down.gif" alt="" /></a><a title="Sort Ascending" href="{$orderbyplatform_asc}"><img src="{$smarty.const.WWW_TOP}/templates/carbon-tmux/images/sorting/arrow_up.gif" alt="" /></a></th>
		...
		<th>release date<br/><a title="Sort Descending" href="{$orderbyreleasedate_desc}"><img src="{$smarty.const.WWW_TOP}/templates/carbon-tmux/images/sorting/arrow_down.gif" alt="" /></a><a title="Sort Ascending" href="{$orderbyreleasedate_asc}"><img src="{$smarty.const.WWW_TOP}/templates/carbon-tmux/images/sorting/arrow_up.gif" alt="" /></a></th>
		...
		<tr class="{cycle values=",alt"}">
			<td class="mid">
				...
				<div class="movextra">
					...
					{if $result.url != ""}<a class="rndbtn" target="_blank" href="{$site->dereferrer_link}{$result.url}" name="amazon{$result.consoleinfoID}" title="View amazon page">Amazon</a>{/if}
