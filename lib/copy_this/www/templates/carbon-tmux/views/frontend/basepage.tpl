...
{if $loggedin=="true"}	<link rel="alternate" type="application/rss+xml" title="{$site->title} Full Rss Feed" href="{$smarty.const.WWW_TOP}/rss?t=0&amp;dl=1&amp;i={$userdata.ID}&amp;r={$userdata.rsstoken}" />{/if}
	...
	<link href="{$smarty.const.WWW_TOP}/templates/carbon-tmux/styles/style.css" rel="stylesheet" type="text/css" media="screen" />
...
{/if}
	...
	<script type="text/javascript" src="{$smarty.const.WWW_TOP}/templates/carbon-tmux/scripts/jquery.colorbox-min.js"></script>
	...
	<script type="text/javascript" src="{$smarty.const.WWW_TOP}/templates/carbon-tmux/scripts/sorttable.js"></script>
