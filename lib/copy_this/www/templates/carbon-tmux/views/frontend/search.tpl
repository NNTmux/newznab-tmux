		...
		<tr class="{cycle values=",alt"}{if $lastvisit|strtotime<$result.adddate|strtotime} new{/if}" id="guid{$result.guid}">
			...
			<td class="item">
				...
				{elseif $result.passwordstatus == 1}
					<img title="Contains .cab/ace Archive" src="{$smarty.const.WWW_TOP}/templates/nntmux/images/icons/lock.gif" alt="Contains .cab/ace Archive" />
				{/if}

				{if $userdata.canpre == 1 && $result.nuketype != ''}
					&nbsp;<img title="{$result.nuketype}" src="{$smarty.const.WWW_TOP}/templates/nntmux/images/icons/nuke.png" width="10" height="10" alt="{$result.nuketype}" />
				{/if}
