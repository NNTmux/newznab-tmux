		...
		<table style="width:100%;" class="data highlight icons" id="browsetable">
			<tr>
				...
				<th>name<br/><a title="Sort Descending" href="{$orderbyname_desc}"><img
								src="{$smarty.const.WWW_TOP}/templates/carbon-tmux/images/sorting/arrow_down.gif"
								alt="Sort Descending"/></a><a title="Sort Ascending" href="{$orderbyname_asc}"><img
								src="{$smarty.const.WWW_TOP}/templates/carbon-tmux/images/sorting/arrow_up.gif"
				...
				<tr class="{cycle values=",alt"}{if $lastvisit|strtotime<$result.adddate|strtotime} new{/if}"
					...
					<td class="item">
						...
						{elseif $result.passwordstatus == 1}
							<img title="Contains .cab/ace Archive"
								 src="{$smarty.const.WWW_TOP}/templates/nntmux/images/icons/lock.gif"
								 alt="Contains .cab/ace Archive"/>
						{/if}
						...
						<div class="resextra">
							<div class="btns">
								...
								{if $result.movieinfoID > 0}<a
									href="{$smarty.const.WWW_TOP}/movies?imdb={$result.imdbID}" title="View movie info"
									class="rndbtn" rel="movie" >Movie</a>{/if}
								...
								{if $result.consoleinfoID > 0}<a href="#" name="name{$result.consoleinfoID}"
																 title="View console info" class="modal_console rndbtn"
					...
					<td class="less right" width="55">{$result.size|fsize_format:"MB"}{if $result.completion > 0}
							<br/>
					...
					<td class="less nowrap"><a title="View comments for {$result.searchname|escape:"htmlall"}"
