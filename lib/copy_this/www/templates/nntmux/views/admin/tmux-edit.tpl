...
<fieldset>
	...
	<table class="input">
		...
		<tr>
			...
			<td>
				<input id="spotnab_timer" name="spotnab_timer" class="short" type="text"
					   value="{$ftmux->spotnab_timer}"/>
...
<fieldset>
	...
	<table class="input">
		...
		<tr>
			<td style="width:180px;"><label for="explain">Information:</label></td>
			<td>
				<div class="explanation">Postprocess others tries to find a valid release in other->misc category.<br/>
				</div>
			</td>
		</tr>
	</table>
		...
		<tr>
			...
			<td>
				<input class="short" id="maxsizetopostprocess" name="maxsizetopostprocess" type="text"
					   value="{$ftmux->maxsizetopostprocess}"/>
		...
		<tr>
			...
			<td>
				<input class="short" id="segmentstodownload" name="segmentstodownload" type="text"
					   value="{$ftmux->segmentstodownload}"/>
