			...
			<ul>
				<li>
					<b>Search</b> <span style="font-family:courier;"><a href="{$smarty.const.WWW_TOP}/api?t=search&amp;q=linux&amp;sort=size_asc">?t=search&amp;q=linux&amp;sort=size_asc</a></span>
					<br/>
					Returns a list of nzbs matching a query. You can also filter by site category, minimum size, maximum size or group name by including a comma separated list as follows <span style="font-family:courier;"><a href="{$smarty.const.WWW_TOP}/api?t=search&amp;cat=1000,2000&amp;group=a.b.multimedia&amp;minsize=0&amp;maxsize=734003200">?t=search&amp;cat=1000,2000&amp;group=a.b.multimedia&amp;minsize=0&amp;maxsize=734003200</a></span>. Include <span style="font-family:courier;">&amp;extended=1</span> to return extended information in the search results. Sort options include cat, name, size, files, stats, posted in the format "value_asc/desc", e.g. &amp;sort=size_desc
				</li>
				<li>
					<b>TV</b> <span style="font-family:courier;"><a href="{$smarty.const.WWW_TOP}/api?t=tvsearch&amp;q=beverly%20hillbillies&amp;season=1&amp;ep=1">?t=tvsearch&amp;q=beverly%20hillbillies&amp;season=1&amp;ep=1</a></span>
					<br/>
				...
				<li>
					<b>Movies</b> <span style="font-family:courier;"><a href="{$smarty.const.WWW_TOP}/api?t=movie&amp;imdbid=0023010">?t=movie&amp;imdbid=0023010</a></span>
					<br/>
					Returns a list of nzbs matching a query, an imdbid and optionally a category or genre. Filter by site category by including a comma separated list of categories as follows <span style="font-family:courier;"><a href="{$smarty.const.WWW_TOP}/api?t=movie&amp;imdbid=0023010&amp;cat=2030,2040&amp;genre=Romance">?t=movie&amp;imdbid=0023010&amp;cat=2030,2040&amp;genre=Romance</a></span>.  Include <span style="font-family:courier;">&amp;extended=1</span> to return extended information in the search results.
				</li>
				<li>
					<b>Music</b> <span style="font-family:courier;"><a href="{$smarty.const.WWW_TOP}/api?t=music&amp;artist=Jack">?t=music&amp;artist=Jack</a></span>
					<br/>
					Returns a list of nzbs matching an audio based query and optionally a category. Filter by site category by including a comma separated list of categories as follows <span style="font-family:courier;"><a href="{$smarty.const.WWW_TOP}/api?t=music&amp;artist=Jack&amp;cat=2030,2040">?t=music&amp;artist=Jack&amp;cat=2030,2040</a></span>.  Include <span style="font-family:courier;">&amp;extended=1</span> to return extended information in the search results. Other search parameters include artist, album, label, year, genre (supports comma separated list).
				</li>
				<li>
					<b>Book</b> <span style="font-family:courier;"><a href="{$smarty.const.WWW_TOP}/api?t=book&amp;author=Daniel">?t=book&amp;author=Daniel</a></span>
					<br/>
					Returns a list of nzbs matching a book based query. Include <span style="font-family:courier;">&amp;extended=1</span> to return extended information in the search results. Other search parameters include title.
				</li>
				<li>
				...
				<li>
					...
					<br/>
					Returns an nfo file for an nzb. Optional parameter <span style="font-family:courier;">&amp;raw=1</span> returns just the nfo file without the rss container.
				</li>
				<li>
			...
			<ul>
				...
				<li>
					<b>CommentAdd</b> <span style="font-family:courier;"><a href="{$smarty.const.WWW_TOP}/api?t=commentadd&amp;id=9ca52909ba9b9e5e6758d815fef4ecda&amp;text=comment">?t=comments&amp;id=9ca52909ba9b9e5e6758d815fef4ecda&amp;text=comment</a></span>
					<br/>
