	...
	{foreach from=$results item=result}
		...
		<div id="moviefull">
            ...
            <p>
                ...
                {if in_array("1", ","|explode:$result.grp_haspreview) && $userdata.canpreview == 1}<br /><strong>Previews:</strong> <a id="showmoviepreviews" href="#">Show previews</a>{/if}
                {if $result.trailer != ''}<br /><strong>Trailer:</strong> <a name="name{$result.imdbID}" class="modal_imdbtrailer" href="#">Show trailer</a>{/if}
            </p>
		</div>
            ...
            {foreach from=$msplits item=m}
                {if $mhaspreview[$m@index] == 1}
                    <a href="{$smarty.const.WWW_TOP}/details/{$mguid[$m@index]}/{$mname[$m@index]|escape:"seourl"}">
                        <img class="shadow pic" src="{$smarty.const.WWW_TOP}/covers/preview/{$mguid[$m@index]}_thumb.jpg" /><br/>
