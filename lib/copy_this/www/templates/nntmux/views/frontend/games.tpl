						...
						<div class="relextra" style="margin-top:5px;">
							{if $result.url != ""}
								<a
										...
										title="View giantbomb page"
										><img src="{$smarty.const.WWW_TOP}/templates/nntmux/images/icons/giantbomb.png"></a>
							{/if}
							<a
									class="label"
									target="_blank"
									...
									><img src="{$smarty.const.WWW_TOP}/templates/nntmux/images/icons/ign.png"></a>
							<a
									class="label"
									target="_blank"
									...
									><img src="{$smarty.const.WWW_TOP}/templates/nntmux/images/icons/gamespot.png"></a>
						</div>
					</div>
				</td>
