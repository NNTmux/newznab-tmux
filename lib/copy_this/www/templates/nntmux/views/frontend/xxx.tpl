				...
				<div class="relextra" style="margin-top:5px;">
					{if $result.classused == "ade"}
						<a
								...
								><img src="{$smarty.const.WWW_TOP}/templates/nntmux/images/icons/ade.png"></a>
					{else}
						<a
								target="_blank"
					...
					{if $result.classused == "hm"}
						<a
								...
								><img src="{$smarty.const.WWW_TOP}/templates/nntmux/images/icons/hotmovies.png"></a>
					{else}
						<a
								target="_blank"
					...
					{if $result.classused == "pop"}
						<a
								...
								><img src="{$smarty.const.WWW_TOP}/templates/nntmux/images/icons/popporn.png"></a>
					{else}
						<a
								target="_blank"
					...
					<a
							...
							><img src="{$smarty.const.WWW_TOP}/templates/nntmux/images/icons/iafd.png"></a>
				</div>
				<hr>
				<div>
					<a
