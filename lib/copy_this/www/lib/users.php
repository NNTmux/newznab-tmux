...
{	
	...
	public function update($id, $uname, $email, $grabs, $role, $notes, $invites, $movieview, $musicview, $consoleview, $bookview, $saburl=false, $sabapikey=false, $sabpriority=false, $sabapikeytype=false, $nzbvortexServerUrl = false, $nzbvortexApiKey = false)
	{			
		$db = new DB();
