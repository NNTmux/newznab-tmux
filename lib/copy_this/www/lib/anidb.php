...
class AniDB
{
	...
	public function __construct(array $options = array())
	{
		...
		$qty = $this->tmux->maxanidbprocessed;
	...
	public function cleanFilename($searchname)
	{
		...
		// there is a case were we have title  tile in this case we want only the first instance, normally these are separated by multiple spaces
