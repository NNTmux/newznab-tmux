...
require_once(WWW_DIR."/lib/SmartyUtils.php");
...
class BasePage
{
	...
	public function __construct()
	{
		...
		$this->smarty->setTemplateDir(
			array(
				'user_frontend' => NN_WWW.'templates/' . $this->settings->getSetting('style') . '/frontend',
		...
		if ($this->users->isLoggedIn()) {
			...
			if (isset($this->userdata['style']) && $this->userdata['style'] !== 'None') {
				$this->smarty->setTemplateDir(
					array(
						'user_frontend' => NN_WWW . 'templates/' . $this->userdata['style'] . '/frontend',
						'frontend'      => NN_WWW . 'templates/default/frontend'
					)
				);
			}
