...
$page->smarty->assign('fix_crap_check_ids', array('blacklist', 'executable', 'gibberish', 'hashed', 'installbin', 'passworded', 'passwordurl', 'sample', 'scr', 'short', 'size', 'huge', 'wmv'));
$page->smarty->assign('fix_crap_check_names', array('blacklist', 'executable', 'gibberish', 'hashed', 'installbin', 'passworded', 'passwordurl', 'sample', 'scr', 'short', 'size', 'huge', 'wmv'));
