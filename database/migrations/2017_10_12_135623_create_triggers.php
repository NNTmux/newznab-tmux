...
class CreateTriggers extends Migration
{
    ...
    public function up()
    {
        DB::unprepared("CREATE TRIGGER check_insert BEFORE INSERT ON releases FOR EACH ROW
  BEGIN
...
CREATE TRIGGER insert_MD5 BEFORE INSERT ON release_comments FOR EACH ROW
  SET
    ...
    public function down()
    {
        ...
        DROP TRIGGER update search;
        DROP TRIGGER delete_search;
        DROP TRIGGER insert_hashes;
        DROP TRIGGER update_hashes;
        DROP TRIGGER delete_hashes;
        DROP TRIGGER insert_MD5;');
    }
}
