...
mix.copy('node_modules/bootstrap/dist/css/bootstrap.min.css', 'public/assets/css/bootstrap.min.css')
    ...
    .copy('node_modules/jquery/dist/jquery.min.js', 'public/assets/jquery/jquery.min.js')
    ...
    .copy('node_modules/@fancyapps/fancybox/dist/jquery.fancybox.min.css', 'public/assets/css/jquery.fancybox.min.css')
    ...
    .copy('node_modules/icheck/skins/flat/green.css', 'public/assets/css/green.css')
    ...
    .copy('node_modules/pnotify/dist/pnotify.animate.js.map','public/assets/js/pnotify.animate.js.map')
    .copy('node_modules/pnotify/dist/pnotify.buttons.js', 'public/assets/js/pnotify.buttons.js')
    .copy('node_modules/pnotify/dist/pnotify.buttons.js.map', 'public/assets/js/pnotify.buttons.js.map')
    .copy('node_modules/pnotify/dist/pnotify.callbacks.js', 'public/assets/js/pnotify.callbacks.js')
    .copy('node_modules/pnotify/dist/pnotify.callbacks.js.map', 'public/assets/js/pnotify.callbacks.js.map')
    .copy('node_modules/pnotify/dist/pnotify.confirm.js', 'public/assets/js/pnotify.confirm.js')
    .copy('node_modules/pnotify/dist/pnotify.confirm.js.map', 'public/assets/js/pnotify.confirm.js.map')
    .copy('node_modules/pnotify/dist/pnotify.desktop.js', 'public/assets/js/pnotify.desktop.js')
    .copy('node_modules/pnotify/dist/pnotify.desktop.js.map', 'public/assets/js/pnotify.desktop.js.map')
    ...
    .copy('node_modules/jquery-multifile/jquery.MultiFile.min.js', 'public/assets/js/jquery.MultiFile.min.js')
