...
/**
	 ...
	 *
	 */
	function copyNZBforImport($relguid, $nzb)
	{
	    $s = new Sites();
        $site = $s->get();
	...
	foreach ($objects as $filestoprocess => $nzbFile) {
		...
		if ($importfailed) {
			...
			if ($usenzbname === true) {
				...
				$cleanerName = $releasecleaning->NameCleaner($subject, $groupName);
			}
			...
			$category = $categorize->determineCategory($groupName, $cleanName );
