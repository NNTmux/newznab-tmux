        ...
        <form method="post" action="{{ url('admin/content-add') }}" class="p-6">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Ordinal -->
                    <div>
                        <label for="ordinal" class="block text-sm font-medium text-gray-700 mb-1">
                            Order (Ordinal)
                        </label>
                        <input type="number"
                               id="ordinal"
                ...
                <div>
                    ...
                    <textarea id="metadescription"
                              ...
                              rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">{{ is_array($content) ? ($content['metadescription'] ?? '') : ($content->metadescription ?? '') }}</textarea>
                ...
                <div class="flex gap-3 pt-4 border-t border-gray-200">
                    ...
                    <a href="{{ url('admin/content-list') }}" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300">
