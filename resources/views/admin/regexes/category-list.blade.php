    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ url('/admin/category-regexes-edit') }}" class="px-4 py-2 bg-primary-600 dark:bg-primary-700 text-white rounded-lg hover:bg-primary-700 dark:hover:bg-primary-800">
        ...
        <div class="px-6 py-4 bg-primary-50 dark:bg-primary-900/20 border-b border-primary-100 dark:border-primary-800">
            <div class="flex">
                <div class="shrink-0">
                    <i class="fas fa-info-circle text-primary-500 dark:text-primary-400 text-2xl"></i>
                </div>
                <div class="ml-3">
                    <p class="text-sm text-primary-700 dark:text-primary-300">
                        This page lists regular expressions used for categorizing releases.<br>
                        You can recategorize all releases by running <code class="bg-primary-100 dark:bg-primary-800 text-primary-800 dark:text-primary-200 px-2 py-1 rounded text-xs">misc/update/update_releases 6 true</code>
                    </p>
                </div>
            </div>
        </div>
                            ...
                            <tr id="row-{{ $row->id }}" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200">
                                        <i class="fas fa-folder-open mr-1"></i>{{ $row->categories_id }}
                                    </span>
                                </td>
        ...
        @else
            <div class="px-6 py-12 text-center">
                ...
                <a href="{{ url('/admin/category-regexes-edit') }}" class="inline-flex items-center px-4 py-2 bg-primary-600 dark:bg-primary-700 text-white rounded-lg hover:bg-primary-700">
                    <i class="fas fa-plus mr-2"></i>Add New Regex
                </a>
            </div>
        @endif
        ...
        <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ url('/admin/category_regexes-edit') }}" class="px-4 py-2 bg-primary-600 dark:bg-primary-700 text-white rounded-lg hover:bg-primary-700 dark:hover:bg-primary-800 text-sm">
                    <i class="fas fa-plus mr-2"></i>Add New Regex
                </a>
            </div>
        </div>
