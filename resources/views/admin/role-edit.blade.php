    ...
    <div class="bg-white rounded-lg shadow-sm">
            ...
            <form method="post" action="{{ url('admin/role-edit') }}" class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Is Default -->
                        <div>
                            <label for="isdefault" class="block text-sm font-medium text-gray-700 mb-1">
                                Default Role
                            </label>
                            <select id="isdefault"
                                    name="isdefault"
        ...
        @else
            <div class="px-6 py-12 text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">Role not found</h3>
                <p class="text-gray-500 mb-4">The requested role could not be found.</p>
                <a href="{{ url('admin/role-list') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
