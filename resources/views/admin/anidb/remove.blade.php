    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm">
        ...
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <div class="flex justify-between items-center">
                ...
                <x-button-link href="{{ route('admin.anidb-list') }}" variant="secondary" icon="fas fa-arrow-left">Back to List</x-button-link>
            </div>
        </div>
        ...
        <div class="p-6">
            ...
            <div class="mt-6 flex items-center justify-between border-t border-gray-200 dark:border-gray-700 pt-6">
                <x-button-link href="{{ route('admin.anidb-list') }}" icon="fas fa-list">Return to AniDB List</x-button-link>
                @if($anidbid)
                    <x-button-link href="{{ url('admin/anidb-edit/' . $anidbid) }}" variant="secondary" icon="fas fa-eye">View Anime Details</x-button-link>
                @endif
            </div>
        </div>
    </div>
