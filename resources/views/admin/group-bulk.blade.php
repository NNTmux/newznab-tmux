    ...
    <div class="bg-white rounded-lg shadow-sm">
        ...
        <div class="px-6 py-6">
            ...
            @else
                ...
                <form action="{{ url('/admin/group-bulk?action=submit') }}" method="POST" id="groupBulkForm">
                    ...
                    <!-- Group Pattern -->
                    <div class="mb-6">
                        <label for="groupfilter" class="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <p class="mt-2 text-sm text-gray-500">
                            ...
                            <br>Example: <code class="bg-gray-100 px-2 py-1 rounded text-xs text-pink-600">alt.binaries.cd.image.linux|alt.binaries.warez.linux</code>
                        </p>
                    </div>
        ...
        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
            <div class="flex justify-between">
                <a href="{{ url('/admin/group-list') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300">
                    <i class="fa fa-arrow-left mr-2"></i>Back to Groups
                </a>
                @if(empty($groupmsglist))
                    <button type="submit" form="groupBulkForm" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
                        <i class="fa fa-plus-circle mr-2"></i>Add Groups
                    </button>
                @else
                    <a href="{{ url('/admin/group-bulk') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
