        ...
        <form method="post" action="{{ route('admin.content-add') }}" class="p-6">
            ...
            <div class="space-y-6">
                ...
                <div class="flex gap-3 pt-4 border-t border-gray-200">
                    <x-button type="submit" icon="fas fa-save">{{ $isEditing ? 'Update' : 'Create' }} Content</x-button>
                    <x-button-link href="{{ route('admin.content-list') }}" variant="muted" icon="fas fa-times">Cancel</x-button-link>
                </div>
            </div>
        </form>
    </x-admin.card>
