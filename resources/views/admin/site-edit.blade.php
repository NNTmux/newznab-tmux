        ...
        <form method="post" action="{{ url('admin/site-edit') }}" class="p-6">
            ...
            <div class="space-y-8">
                ...
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Main Site Settings, HTML Layout, Tags</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="strapline" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            ...
                            <textarea id="metadescription" name="metadescription" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">{{ $site->metadescription ?? '' }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="metakeywords" name="metakeywords" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">{{ $site->metakeywords ?? '' }}</textarea>
                            <p class="mt-1 text-sm text-gray-500">Stem meta-keywords appended to all page meta keyword tags.</p>
                        </div>

                        <div>
                            <label for="footer" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-copyright mr-1"></i>Footer
                            </label>
                            <textarea id="footer" name="footer" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">{{ $site->footer ?? '' }}</textarea>
                            <p class="mt-1 text-sm text-gray-500">Displayed in the footer section of every public page.</p>
                        </div>

                        <div>
                            <label for="home_link" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="dereferrer_link" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="tandc" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-gavel mr-1"></i>Terms and Conditions
                            </label>
                            <textarea id="tandc" name="tandc" rows="5"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">{{ $site->tandc ?? '' }}</textarea>
                ...
                <!-- Usenet Settings -->
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Usenet Settings</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="nzbsplitlevel" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="partretentionhours" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="releaseretentiondays" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="miscotherretentionhours" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="mischashedretentionhours" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="partsdeletechunks" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="minfilestoformrelease" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="minsizetoformrelease" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="maxsizetoformrelease" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="completionpercent" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="grabstatus" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-sync mr-1"></i>Update Grabs
                            </label>
                            <select id="grabstatus" name="grabstatus" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            <label for="crossposttime" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="maxmssgs" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="max_headers_iteration" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="newgroupscanmethod" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-question-circle mr-1"></i>Where to Start New Groups
                            </label>
                            <select id="newgroupscanmethod" name="newgroupscanmethod" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 mb-2">
                                @foreach($yesno_ids as $index => $yesnoId)
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <div>
                                    <label for="newgroupdaystoscan" class="block text-xs text-gray-600 mb-1">Days to Scan</label>
                                    <input type="text" id="newgroupdaystoscan" name="newgroupdaystoscan" value="{{ $site->newgroupdaystoscan ?? '' }}"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div>
                                    <label for="newgroupmsgstoscan" class="block text-xs text-gray-600 mb-1">Posts to Scan</label>
                        ...
                        <div>
                            <label for="safebackfilldate" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="disablebackfillgroup" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-power-off mr-1"></i>Auto Disable Groups During Backfill
                            </label>
                            <select id="disablebackfillgroup" name="disablebackfillgroup" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                ...
                <!-- Lookup Settings -->
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Lookup Settings</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="lookuptv" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-tv mr-1"></i>Lookup TV
                            </label>
                            <select id="lookuptv" name="lookuptv" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            <label for="lookupbooks" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-book mr-1"></i>Lookup Books
                            </label>
                            <select id="lookupbooks" name="lookupbooks" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            <label for="book_reqids" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-list mr-1"></i>Type of Books to Look Up
                            </label>
                            <select id="book_reqids" name="book_reqids[]" multiple class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" size="4">
                        ...
                        <div>
                            <label for="lookupimdb" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-film mr-1"></i>Lookup Movies
                            </label>
                            <select id="lookupimdb" name="lookupimdb" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            <label for="lookuplanguage" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-language mr-1"></i>Movie Lookup Language
                            </label>
                            <select id="lookuplanguage" name="lookuplanguage" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            <label for="lookupanidb" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-dragon mr-1"></i>Lookup AniDB
                            </label>
                            <select id="lookupanidb" name="lookupanidb" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            <label for="lookupmusic" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-music mr-1"></i>Lookup Music
                            </label>
                            <select id="lookupmusic" name="lookupmusic" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            <label for="saveaudiopreview" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-music mr-1"></i>Save Audio Preview
                            </label>
                            <select id="saveaudiopreview" name="saveaudiopreview" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            <label for="lookupgames" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-gamepad mr-1"></i>Lookup Games
                            </label>
                            <select id="lookupgames" name="lookupgames" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            <label for="lookupxxx" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-video mr-1"></i>Lookup XXX
                            </label>
                            <select id="lookupxxx" name="lookupxxx" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                ...
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Language/Categorization Options</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="categorizeforeign" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-globe mr-1"></i>Categorize Foreign
                            </label>
                            <select id="categorizeforeign" name="categorizeforeign" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            <label for="catwebdl" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-cloud-download-alt mr-1"></i>Categorize WEB-DL
                            </label>
                            <select id="catwebdl" name="catwebdl" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                ...
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">User Settings</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="registerstatus" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-user-plus mr-1"></i>Registration Status
                            </label>
                            <select id="registerstatus" name="registerstatus" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            <label for="userdownloadpurgedays" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="userhostexclusion" class="block text-sm font-medium text-gray-700 mb-1">
                ...
                <!-- Path Settings -->
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Path Settings</h2>
                    <div class="space-y-4">
                        <div>
                            <label for="nzbpath" class="block text-sm font-medium text-gray-700 mb-1">NZB Path</label>
                        ...
                        <div>
                            <label for="coverspath" class="block text-sm font-medium text-gray-700 mb-1">Covers Path</label>
                ...
                <!-- Password Settings -->
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Password Settings</h2>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="end" name="end" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            <label for="showpasswordedrelease" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-lock mr-1"></i>Show Passworded Releases
                            </label>
                            <select id="showpasswordedrelease" name="showpasswordedrelease" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Additional Usenet Settings</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="maxsizetopostprocess" class="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div class="flex gap-2">
                                ...
                                <span class="px-3 py-2 bg-gray-100 border border-gray-300 rounded-md">GB</span>
                            </div>
                            <p class="mt-1 text-sm text-gray-500">The maximum size in gigabytes to postprocess a release. If set to 0, then ignored.</p>
                        </div>

                        <div>
                            <label for="minsizetopostprocess" class="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div class="flex gap-2">
                                <input type="text" id="minsizetopostprocess" name="minsizetopostprocess" value="{{ $site->minsizetopostprocess ?? '' }}"
                                       class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                <span class="px-3 py-2 bg-gray-100 border border-gray-300 rounded-md">MB</span>
                            </div>
                ...
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Advanced Settings - For Advanced Users</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="maxnzbsprocessed" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="partrepair" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-toolbox mr-1"></i>Part Repair
                            </label>
                            <select id="partrepair" name="partrepair" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            <label for="safepartrepair" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-shield-alt mr-1"></i>Part Repair for Backfill Scripts
                            </label>
                            <select id="safepartrepair" name="safepartrepair" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            <label for="maxpartrepair" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="partrepairmaxtries" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="processjpg" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-image mr-1"></i>Process JPG
                            </label>
                            <select id="processjpg" name="processjpg" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            <label for="processthumbnails" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-file-image mr-1"></i>Process Video Thumbnails
                            </label>
                            <select id="processthumbnails" name="processthumbnails" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            <label for="processvideos" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-film mr-1"></i>Process Video Samples
                            </label>
                            <select id="processvideos" name="processvideos" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            <label for="segmentstodownload" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="ffmpeg_duration" class="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div class="flex gap-2">
                                <input type="text" id="ffmpeg_duration" name="ffmpeg_duration" value="{{ $site->ffmpeg_duration ?? '' }}"
                                       class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                <span class="px-3 py-2 bg-gray-100 border border-gray-300 rounded-md">seconds</span>
                            </div>
                            <p class="mt-1 text-sm text-gray-500">The maximum duration (in seconds) for ffmpeg to generate the sample for. (Default 5)</p>
                        </div>

                        <div>
                            <label for="maxnestedlevels" class="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div class="flex gap-2">
                                <input type="text" id="maxnestedlevels" name="maxnestedlevels" value="{{ $site->maxnestedlevels ?? '' }}"
                                       class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                <span class="px-3 py-2 bg-gray-100 border border-gray-300 rounded-md">levels</span>
                            </div>
                        ...
                        <div>
                            <label for="innerfileblacklist" class="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <textarea id="innerfileblacklist" name="innerfileblacklist" rows="3" placeholder="Example: /setup\.exe|password\.url/i"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">{{ $site->innerfileblacklist ?? '' }}</textarea>
                ...
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Movie Trailer Settings</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="trailers_display" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-play-circle mr-1"></i>Fetch/Display Movie Trailers
                            </label>
                            <select id="trailers_display" name="trailers_display" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            <label for="trailers_size_x" class="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div class="flex gap-2">
                                <input type="text" id="trailers_size_x" name="trailers_size_x" value="{{ $site->trailers_size_x ?? '' }}"
                                       class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                <span class="px-3 py-2 bg-gray-100 border border-gray-300 rounded-md">px</span>
                            </div>
                            <p class="mt-1 text-sm text-gray-500">Maximum width in pixels for the trailer window. (Default: 480)</p>
                        </div>

                        <div>
                            <label for="trailers_size_y" class="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Advanced - Postprocessing Settings</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="timeoutseconds" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="maxaddprocessed" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="maxpartsprocessed" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="passchkattempts" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="maxrageprocessed" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="maximdbprocessed" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="maxanidbprocessed" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="maxmusicprocessed" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="maxgamesprocessed" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="maxbooksprocessed" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="maxxxxprocessed" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="fixnamesperrun" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="amazonsleep" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-hourglass mr-1"></i>Amazon Sleep Time
                            </label>
                            <div class="flex gap-2">
                                <input type="text" id="amazonsleep" name="amazonsleep" value="{{ $site->amazonsleep ?? '' }}"
                                       class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                <span class="px-3 py-2 bg-gray-100 border border-gray-300 rounded-md">ms</span>
                            </div>
                ...
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">NFO Processing Settings</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="lookupnfo" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-file-alt mr-1"></i>Lookup NFO
                            </label>
                            <select id="lookupnfo" name="lookupnfo" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            <label for="maxnfoprocessed" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="maxsizetoprocessnfo" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="minsizetoprocessnfo" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="maxnforetries" class="block text-sm font-medium text-gray-700 mb-1">
                            ...
                            <div class="flex gap-2">
                                <input type="text" id="maxnforetries" name="maxnforetries" value="{{ $site->maxnforetries ?? '' }}"
                                       class="flex-1 px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                <span class="px-3 py-2 bg-gray-100 border border-gray-300 rounded-md">times</span>
                            </div>
                ...
                <!-- Connection Settings -->
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Connection Settings</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="nntpretries" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="delaytime" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="collection_timeout" class="block text-sm font-medium text-gray-700 mb-1">
                ...
                <!-- Developer Settings -->
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Developer Settings</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="showdroppedyencparts" class="block text-sm font-medium text-gray-700 mb-1">
                                <i class="fa fa-bug mr-1"></i>Log Dropped Headers
                            </label>
                            <select id="showdroppedyencparts" name="showdroppedyencparts" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                ...
                <div class="border-b border-gray-200 pb-6">
                    <h2 class="text-lg font-semibold text-gray-800 mb-4">Advanced - Threaded Settings</h2>

                    <div class="space-y-4">
                        <div>
                            <label for="binarythreads" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="backfillthreads" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="releasethreads" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="postthreads" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="nfothreads" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="postthreadsnon" class="block text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div>
                            <label for="fixnamethreads" class="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div class="flex gap-3 pt-4 border-t border-gray-200">
                    ...
                    <a href="{{ url('admin') }}" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300">
