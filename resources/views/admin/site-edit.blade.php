                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="metadescription" name="metadescription" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">{{ $site->metadescription ?? '' }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="metakeywords" name="metakeywords" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">{{ $site->metakeywords ?? '' }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="footer" name="footer" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">{{ $site->footer ?? '' }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="tandc" name="tandc" rows="5"
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">{{ $site->tandc ?? '' }}</textarea>
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="grabstatus" name="grabstatus" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <select id="newgroupscanmethod" name="newgroupscanmethod" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500 mb-2">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            ...
                            <select id="disablebackfillgroup" name="disablebackfillgroup" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="lookuptv" name="lookuptv" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <select id="lookupbooks" name="lookupbooks" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <select id="book_reqids" name="book_reqids[]" multiple class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500" size="4">
                        ...
                        <div>
                            ...
                            <select id="lookupimdb" name="lookupimdb" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <select id="lookuplanguage" name="lookuplanguage" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <select id="lookupanidb" name="lookupanidb" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            ...
                            <select id="lookupmusic" name="lookupmusic" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <select id="saveaudiopreview" name="saveaudiopreview" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            ...
                            <select id="lookupgames" name="lookupgames" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <select id="lookupxxx" name="lookupxxx" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="categorizeforeign" name="categorizeforeign" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            ...
                            <select id="catwebdl" name="catwebdl" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="registerstatus" name="registerstatus" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="end" name="end" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            ...
                            <select id="showpasswordedrelease" name="showpasswordedrelease" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <input type="text" id="maxsizetopostprocess" name="maxsizetopostprocess" value="{{ $site->maxsizetopostprocess ?? '' }}"
                                       class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="partrepair" name="partrepair" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            ...
                            <select id="safepartrepair" name="safepartrepair" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            ...
                            <select id="processjpg" name="processjpg" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            ...
                            <select id="processthumbnails" name="processthumbnails" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            ...
                            <select id="processvideos" name="processvideos" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                        ...
                        <div>
                            ...
                            <textarea id="innerfileblacklist" name="innerfileblacklist" rows="3" placeholder="Example: /setup\.exe|password\.url/i"
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">{{ $site->innerfileblacklist ?? '' }}</textarea>
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="trailers_display" name="trailers_display" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="lookupnfo" name="lookupnfo" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select id="showdroppedyencparts" name="showdroppedyencparts" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                @foreach($yesno_ids as $index => $yesnoId)
