    ...
    <div class="bg-white rounded-lg shadow-sm">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ url('/admin/category_regexes-list') }}" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200">
        ...
        <form action="{{ url('/admin/category_regexes-edit?action=submit') }}" method="POST" id="regexForm" class="px-6 py-6">
            ...
            <!-- Category -->
            <div class="mb-6">
                <label for="categories_id" class="block text-sm font-medium text-gray-700 mb-2">
        ...
        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
            <div class="flex justify-between">
                <a href="{{ url('/admin/category_regexes-list') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300">
