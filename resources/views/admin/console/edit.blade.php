    ...
    <x-admin.card>
        ...
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <div class="flex justify-between items-center">
                ...
                <x-button-link href="{{ route('admin.console-list') }}" variant="secondary" icon="fas fa-arrow-left">
                    Back to List
                </x-button-link>
            </div>
        </div>
        ...
        <div class="p-6">
            <form method="POST" action="{{ url('admin/console-edit?id=' . $con['id']) }}" enctype="multipart/form-data">
                ...
                <div class="mt-6 flex items-center justify-between border-t border-gray-200 dark:border-gray-700 pt-6">
                    <x-button-link href="{{ route('admin.console-list') }}" variant="secondary" icon="fas fa-times">
                        Cancel
                    </x-button-link>
