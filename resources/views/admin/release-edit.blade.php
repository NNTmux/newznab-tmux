...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('admin.release-edit') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Total Parts -->
                <div>
                    <label for="totalpart" class="block text-sm font-medium text-gray-700 mb-2">
                        Total Parts
                    </label>
                    <input type="number"
                           id="totalpart"
                ...
                <!-- Grabs -->
                <div>
                    <label for="grabs" class="block text-sm font-medium text-gray-700 mb-2">
                        Grabs
                    </label>
                    <input type="number"
                           id="grabs"
                ...
                <!-- Post Date -->
                <div>
                    <label for="postdate" class="block text-sm font-medium text-gray-700 mb-2">
                        Post Date
                    </label>
                ...
                <!-- Add Date -->
                <div>
                    <label for="adddate" class="block text-sm font-medium text-gray-700 mb-2">
                        Add Date
                    </label>
                    <input type="datetime-local"
                           id="adddate"
                ...
                <!-- Video ID -->
                <div>
                    <label for="videos_id" class="block text-sm font-medium text-gray-700 mb-2">
                        Video ID
                    </label>
                    <input type="number"
                           id="videos_id"
                ...
                <!-- TV Episode ID -->
                <div>
                    <label for="tv_episodes_id" class="block text-sm font-medium text-gray-700 mb-2">
                        TV Episode ID
                    </label>
                    <input type="number"
                           id="tv_episodes_id"
                ...
                <!-- IMDB ID -->
                <div>
                    <label for="imdbid" class="block text-sm font-medium text-gray-700 mb-2">
                        IMDB ID
                    </label>
                    <input type="text"
                           id="imdbid"
                ...
                <!-- AniDB ID -->
                <div>
                    <label for="anidbid" class="block text-sm font-medium text-gray-700 mb-2">
                        AniDB ID
                    </label>
                    <input type="number"
                           id="anidbid"
            ...
            <div class="mt-6 flex gap-3">
                ...
                <a href="{{ route('admin.release-list') }}" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition inline-flex items-center">
                    <i class="fas fa-times mr-2"></i> Cancel
                </a>
                <a href="{{ url('/details/' . ($release->guid ?? $release['guid'] ?? '')) }}" class="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition inline-flex items-center">
    ...
    <div class="bg-gray-50 rounded-lg p-4 mt-6">
        <h3 class="text-lg font-semibold text-gray-800 mb-3">Release Information</h3>
        <dl class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div>
                <dt class="font-medium text-gray-600">GUID</dt>
                <dd class="text-gray-900 font-mono text-xs mt-1">{{ $release->guid ?? $release['guid'] ?? 'N/A' }}</dd>
            </div>
            <div>
                <dt class="font-medium text-gray-600">Group</dt>
                <dd class="text-gray-900 mt-1">{{ $release->group_name ?? $release['group_name'] ?? 'N/A' }}</dd>
            </div>
            <div>
