<!-- File List Modal - Alpine.js CSP Safe -->
<div x-data="filelistModal"
     x-show="open"
     x-cloak
     class="fixed inset-0 z-50 overflow-y-auto"
     aria-labelledby="filelist-modal-title"
     role="dialog"
     aria-modal="true"
            ...
            <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100" id="filelist-modal-title">
                        <i class="fas fa-folder-open mr-2 text-primary-600 dark:text-primary-400"></i>File List
                    </h3>
                ...
                <div x-show="loading" class="flex items-center justify-center py-8">
                    <i class="fas fa-spinner fa-spin text-2xl mr-2 text-primary-600 dark:text-primary-400"></i>
                    <span class="text-gray-600 dark:text-gray-400">Loading file list...</span>
                </div>
