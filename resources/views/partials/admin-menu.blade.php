<div class="space-y-2 px-4">
    ...
    <div class="mb-4">
        ...
        <div id="users-menu" class="hidden mt-2 ml-6 space-y-1">
            ...
            <a href="{{ url('/admin/deleted-users') }}" class="block py-2 px-3 text-gray-400 hover:text-white hover:bg-gray-800 rounded transition">Deleted Users</a>
        </div>
    </div>
    ...
    <!-- Blacklist -->
    <div class="mb-4">
        <button type="button" class="flex items-center justify-between w-full text-left text-gray-300 hover:text-white transition" onclick="toggleAdminSubmenu('blacklist-menu')">
            <div class="flex items-center space-x-3">
        ...
        <div id="blacklist-menu" class="hidden mt-2 ml-6 space-y-1">
            <a href="{{ url('/admin/binaryblacklist-list') }}" class="block py-2 px-3 text-gray-400 hover:text-white hover:bg-gray-800 rounded transition">Binary Blacklist</a>
        </div>
    </div>

    <!-- Regexes -->
    <div class="mb-4">
        <button type="button" class="flex items-center justify-between w-full text-left text-gray-300 hover:text-white transition" onclick="toggleAdminSubmenu('regexes-menu')">
            <div class="flex items-center space-x-3">
