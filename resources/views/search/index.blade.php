                ...
                @foreach($results as $result)
                    <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-md transition">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <a href="{{ url('/details/' . $result->guid) }}" class="text-lg font-medium text-blue-600 dark:text-blue-400 hover:text-blue-800">
                                    {{ $result->searchname }}
                                </a>
                            ...
                            <div class="ml-4 flex gap-2">
                                <a href="{{ url('/getnzb/' . $result->guid) }}"
                                   class="px-3 py-2 bg-green-600 dark:bg-green-700 text-white rounded hover:bg-green-700 dark:hover:bg-green-800 transition text-sm"
                                   title="Download NZB">
