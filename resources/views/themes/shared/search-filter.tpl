{if isset($covgroup)}
	...
	{if $covgroup == "movies"}
        ...
        {{Form::open(['name' => 'browseby', 'url' => 'Movies', 'class' => 'form-inline', 'method' => 'get'])}}
			<input class="form-inline form-control-sm" id="movietitle" type="text" name="title" value="{$title}"
				   placeholder="Title">
			<input class="form-inline form-control-sm"  id="movieactors" type="text" name="actors"
				   value="{$actors}"
				   placeholder="Actor">
			<input class="form-inline form-control-sm" id="moviedirector" type="text" name="director"
				   value="{$director}" placeholder="Director">
			<select class="form-inline form-control-sm" id="rating" name="rating">
				<option class="grouping" value="">Rating...</option>
				{foreach $ratings as $rate}
					<option {if $rating == $rate}selected="selected"{/if} value="{$rate}">{$rate}</option>
				{/foreach}
			</select>
			<select class="form-inline form-control-sm" id="genre" name="genre">
				<option class="grouping" value="">Genre...</option>
				{foreach $genres as $gen}
					<option {if $gen == $genre}selected="selected"{/if} value="{$gen}">{$gen}</option>
				{/foreach}
			</select>
			<select class="form-inline form-control-sm" id="year" name="year">
				<option class="grouping" value="">Year...</option>
				{foreach $years as $yr}
					<option {if $yr == $year}selected="selected"{/if} value="{$yr}">{$yr}</option>
				{/foreach}
			</select>
			<select class="form-inline form-control-sm" id="category" name="t">
	...
	{if $covgroup == "xxx"}
        ...
        {{Form::open(['name' => 'browseby', 'url' => 'XXX', 'class' => 'form-inline', 'method' => 'get'])}}
			<input class="form-inline form-control-sm"
				   style="width: 150px;"
				   id="xxxtitle"
				   type="text"
				   name="title"
	...
	{if $covgroup == "books"}
        ...
        {{Form::open(['name' => 'browseby', 'url' => 'Books', 'class' => 'form-inline', 'method' => 'get'])}}
			<input class="form-inline form-control-sm" id="author" type="text" name="author" value="{$author}"
				   placeholder="Author">
			<input class="form-inline form-control-sm" id="title" type="text" name="title" value="{$title}"
				   placeholder="Title">
		{{Form::submit('Search', ['class' => 'btn btn-outline-success my-2 my-sm-0'])}}
		{{Form::close()}}
        </div>
	...
	{if $covgroup == "music"}
        ...
        {{Form::open(['name' => 'browseby', 'url' => 'Audio', 'class' => 'form-inline'])}}
			<input class="form-inline form-control-sm" id="musicartist" type="text" name="artist"
				   value="{$artist}"
				   placeholder="Artist">
			<input class="form-inline form-control-sm" id="musictitle" type="text" name="title" value="{$title}"
				   placeholder="Title">
			<select class="form-inline form-control-sm" id="genre" name="genre">
				<option class="grouping" value="">Genre...</option>
				{foreach $genres as $gen}
	...
	{if $covgroup == "console"}
        ...
        {{Form::open(['name' => 'browseby', 'url' => 'Console', 'class' => 'form-inline', 'method' => 'get'])}}
			<input class="form-inline form-control-sm" id="title" type="text" name="title" value="{$title}"
				   placeholder="Title">
			<input class="form-inline form-control-sm" id="platform" type="text" name="platform"
				   value="{$platform}"
...
{if {$smarty.get.page} == "console"}
    ...
    {{Form::open(['name' => 'browseby', 'url' => 'Console', 'class' => 'form-inline', 'method' => 'get'])}}
		<input class="form-inline form-control-sm" id="title" type="text" name="title" value="{$title}"
			   placeholder="Title">
		<input class="form-inline form-control-sm" id="platform" type="text" name="platform" value="{$platform}"
			   placeholder="Platform">
		<select class="form-inline form-control-sm" style="width: auto;" id="genre" name="genre">
			<option class="grouping" value="">Genre...</option>
			{foreach $genres as $gen}
				<option {if $gen->id == $genre}selected="selected"{/if} value="{$gen->id}">{$gen->title}</option>
			{/foreach}
		</select>
		<select class="form-inline form-control-sm" style="width: auto;" id="category" name="t">
			<option class="grouping" value="{$catClass::GAME_ROOT}">Category...</option>
			{foreach $catlist as $ct}
				<option {if $ct.id == $category}selected="selected"{/if} value="{$ct.id}">{$ct.title}</option>
			{/foreach}
...
{if {$smarty.get.page} == "games"}
    ...
    {{Form::open(['name' => 'browseby', 'url' => 'Games', 'class' => 'form-inline', 'method' => 'get'])}}
		<input class="form-inline form-control-sm" id="title" type="text" name="title" value="{$title}"
			   placeholder="Title">
		<select class="form-inline form-inline-sm" style="width: auto;" id="genre" name="genre">
			<option class="grouping" value="">Genre...</option>
			{foreach $genres as $gen}
				<option {if $gen->id == $genre}selected="selected"{/if} value="{$gen->id}">{$gen->title}</option>
			{/foreach}
