<div class="well well-sm">
	...
	{if $loggedin=="true"}
		...
		<p>Your credentials should be provided as <span style="font-family:courier;">&apikey={$userdata.rsstoken}</span>
		</p>
	{/if}
	<br>
	...
	<dl>
		...
		<br>
		<dt>Search <span style="font-family:courier;"><a href="{$smarty.const.WWW_TOP}/api/v1/api?t=search&amp;q=linux">?t=search&amp;q=linux</a></span>
		</dt>
		<dd>Returns a list of nzbs matching a query. You can also filter by site category by including a comma separated
			list of categories as follows <span style="font-family:courier;"><a
						href="{$smarty.const.WWW_TOP}/api?t=search&amp;cat={$catClass::GAME_ROOT},{$catClass::MOVIE_ROOT}">?t=search&amp;cat={$catClass::GAME_ROOT}
		...
		<dt>TV <span style="font-family:courier;"><a
						href="{$smarty.const.WWW_TOP}/api/v1/api?t=tvsearch&amp;q=law%20and%20order&amp;season=7&amp;ep=12">?t=tvsearch&amp;q=law and order&amp;season=7&amp;ep=12</a></span>
		</dt>
		<dd>Returns a list of nzbs matching a query, category, tvrageid, season or episode.
			...
			<span style="font-family:courier;"><a
						href="{$smarty.const.WWW_TOP}/api/v1/api?t=tvsearch&amp;rid=2204&amp;cat={$catClass::GAME_ROOT},{$catClass::MOVIE_ROOT}">?t=tvsearch&amp;cat={$catClass::GAME_ROOT}
		...
		<dt>Movies <span style="font-family:courier;"><a
						href="{$smarty.const.WWW_TOP}/api/v1/api?t=movie&amp;imdbid=1418646">?t=movie&amp;imdbid=1418646</a></span>
		</dt>
		<dd>Returns a list of nzbs matching a query, an imdbid and optionally a category. Filter by
			site category by including a comma separated list of categories as follows <span
					style="font-family:courier;"><a
						href="{$smarty.const.WWW_TOP}/api/v1/api?t=movie&amp;imdbid=1418646&amp;cat={$catClass::MOVIE_SD},{$catClass::MOVIE_HD}">?t=movie&amp;imdbid=1418646&amp;cat={$catClass::MOVIE_SD}
		...
		<dt>Details <span style="font-family:courier;"><a
						href="{$smarty.const.WWW_TOP}/api/v1/api?t=details&amp;id=9ca52909ba9b9e5e6758d815fef4ecda">?t=details&amp;id=9ca52909ba9b9e5e6758d815fef4ecda</a></span>
		</dt>
		<dd>Returns detailed information about an nzb.</dd>
		<br>
		<dt>Info <span style="font-family:courier;"><a
						href="{$smarty.const.WWW_TOP}/api/v1/api?t=info&amp;id=9ca52909ba9b9e5e6758d815fef4ecda">?t=info&amp;id=9ca52909ba9b9e5e6758d815fef4ecda</a></span>
		</dt>
		...
		<dt>Get <span style="font-family:courier;"><a
						href="{$smarty.const.WWW_TOP}/api/v1/api?t=get&amp;id=9ca52909ba9b9e5e6758d815fef4ecda">?t=get&amp;id=9ca52909ba9b9e5e6758d815fef4ecda</a></span>
		</dt>
