						...
						<table class="data table table-striped responsive-utilities jambo-table" id="browsetable">
							...
							{foreach $results as $result}
								<tr class="{cycle values=",alt"}{if $lastvisit|strtotime<$result->adddate|strtotime} new{/if}"
									...
									<td class="posted" title="{{Timezone::convertToLocal(Illuminate\Support\Carbon::createFromFormat('Y-m-d H:i:s', $result->postdate), 'Y-m-d h:i:s')}}">
                                        {{{Timezone::convertToLocal(Illuminate\Support\Carbon::createFromFormat('Y-m-d H:i:s', $result->postdate), 'Y-m-d h:i:s')}}|timeago}
									</td>
									<td class="size">
