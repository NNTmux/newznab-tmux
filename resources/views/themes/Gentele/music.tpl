						            ...
						            <div class="row">
						                <div class="col-md-4">
						                    <div class="d-flex align-items-center">
						                        <div class="me-3">
						                            <span>View: <strong>Covers</strong> | <a href="{{url("/browse/Audio/{$categorytitle}")}}">List</a></span>
						                        </div>
						                        <div class="d-flex align-items-center">
						        ...
						        <div class="card-body">
						                                            ...
						                                            <div class="position-relative mb-2">
						                                                <a href="{{url("/details/{$result->guid}")}}">
						                                                    <img class="cover img-fluid rounded shadow"
						                                                         src="{{url("/covers/music/{if $result->cover == 1}{$result->musicinfo_id}.jpg{else}{{asset("/assets/images/no-cover.png")}}{/if}")}}"
						                                            ...
						                                            <div class="d-flex flex-wrap gap-1 mb-2 external-links">
						                                                {if $result->url != ""}
						                                                    <a target="_blank" href="{$site->dereferrer_link}{$result->url}"
						                                                       title="View Amazon/iTunes page" class="badge bg-secondary text-white text-decoration-none badge-link" rel="amazon">
						                                        ...
						                                        <div class="col-md-8">
						                                            ...
						                                            <h5 class="mb-2">
						                                                <a class="text-decoration-none title-link" href="{{url("/details/{$result->guid}")}}">
						                                                    {$result->artist|escape:"htmlall"} - {$result->title|escape:"htmlall"}
						                                                    {if $result->year != ""}
						                                            ...
						                                            <div class="mb-3 small">
						                                                {if $result->genre != ""}
						                                                    <div class="d-flex align-items-center mb-1">
						                                                        ...
						                                                        <div class="genre-tags">
						                                                            <a href="{{url("/music/?genre={$result->genres_id}")}}" class="badge bg-light text-dark me-1">{$result->genre|escape:"htmlall"}</a>
						                                                        </div>
						                                                    </div>
						                                                {/if}
						                                                ...
						                                                {if $result->publisher != ""}
						                                                    <div class="d-flex align-items-center mb-1">
						                                                        ...
						                                                        <span><strong>Publisher:</strong> {$result->publisher|escape:"htmlall"}</span>
						                                                    </div>
						                                                {/if}
						            ...
						            {else}
						                <div class="alert alert-info">
						                    ...
						                    No music releases with covers available!
						                </div>
						            {/if}
						        </div>
