							                                                            ...
							                                                            {foreach $msplits as $m}
							                                                                {if $m@first}
							                                                                    ...
							                                                                    <div class="d-flex flex-wrap gap-1 mb-2 external-links">
							                                                                        ...
							                                                                        {if $mnfo[$m@index] > 0}
							                                                                            <a href="{{url("/nfo/{$mguid[$m@index]}")}}" data-guid="{$mguid[$m@index]}"
							                                                                        ...
							                                                                        <div class="card-body p-3">
							                                                                            <div class="d-flex justify-content-between align-items-start mb-2">
							                                                                                ...
							                                                                                <div class="d-flex align-items-center">
							                                                                                    ...
							                                                                                    <span class="badge bg-secondary">{$msize[$m@index]|filesize}</span>
							                                                                                </div>
							                                                                            </div>

							                                                                            <div class="d-flex align-items-center text-muted mb-2">
							                                                                                <i class="fa fa-clock-o me-2"></i>
							                                                                                <span>Posted {$mpostdate[$m@index]|timeago} ago</span>
							                                                                            </div>

							                                                                            <!-- Release Name -->
							                                                                            <div class="text-truncate mb-3">
							                                                                                <a href="{{url("/details/{$mguid[$m@index]}")}}" class="text-muted text-decoration-none">
							                                                                            ...
							                                                                            <div class="d-flex gap-2">
							                                                                                <a class="btn btn-sm btn-primary"
							                                                                                   ...
							                                                                                   href="{{url("/getnzb?id={$mguid[$m@index]}")}}">
							                                                                                    ...
							                                                                                    <span class="badge bg-light text-dark">{$mgrabs[$m@index]}</span>
							                                                                                </a>

							                                                                                <a class="btn btn-sm btn-outline-secondary"
							                                                                                   href="{{url("/details/{$mguid[$m@index]}/#comments")}}">
							                                                                                    <i class="fa fa-comment-o me-1"></i>
							                                                                                    <span class="badge bg-light text-dark">{$mcomments[$m@index]}</span>
							                                                                                </a>
