                                                ...
                                                <div class="card-body p-3">
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        <div>
                                                            ...
                                                            {if isset($catnamesplit[0])}
                                                                <span class="badge bg-primary"><i class="fa fa-folder me-1"></i>{$catnamesplit[0]}</span>
                                                            {/if}

                                                            {if isset($catnamesplit[1])}
                                                                <span class="badge bg-danger"><i class="fa fa-folder-open me-1"></i>{$catnamesplit[1]}</span>
                                                            {/if}
