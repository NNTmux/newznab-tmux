<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/"
	...
	<Image width="16" height="16">{$smarty.const.WWW_ASSETS}/images/favicon.ico</Image>
	...
	<moz:IconUpdateUrl>{$smarty.const.WWW_ASSETS}/images/favicon.ico</moz:IconUpdateUrl>
