	...
	{foreach $results as $result}
		<tr class="{cycle values=",alt"}{if $lastvisit|strtotime<$result.adddate|strtotime} new{/if}" id="guid{$result.guid}">
			...
			<td class="item">
				...
				&nbsp;<img title="{$result.nuketype}" src="{$smarty.const.WWW_ASSETS}/images/icons/nuke.png" width="10" height="10" alt="{$result.nuketype}" />
				{/if}
				<div class="resextra">
					<div class="btns">{strip}
						...
						<a class="badge badge-inverse halffade" href="{$smarty.const.WWW_TOP}/series?id={$result.videos_id}" title="View all episodes">View Series</a>
						{/if}
						{if $result.anidbid > 0}
						<a class="badge badge-inverse halffade" href="{$smarty.const.WWW_TOP}/anime?id={$result.anidbid}" title="View all episodes">View Anime</a>
						{/if}
                    ...
                    {if $weHasVortex}
                        <li>
                            <a class="icon icon_nzb fa fa-cloud-downloadvortex" href="#" title="Send to NZBVortex">
                                <img class="icon icon_nzb fa fa-cloud-downloadvortex" alt="Send to my NZBVortex" src="{$smarty.const.WWW_ASSETS}/images/icons/vortex/bigsmile.png">
                            </a>
                        </li>
                    {/if}
				</ul>
