...
<table class="data highlight Sortable table" id="browsetable">
	...
	{foreach $shows as $show}
		<tr class="{cycle values=",alt"}">
			<td>
				<a title="View details" href="{$smarty.const.WWW_TOP}/series?id={$show.videos_id}{if $show.categories != ''}?t={$show.categories|replace:"|":","}{/if}"><h5>{$show.title|escape:"htmlall"|wordwrap:75:"\n":true}</h5></a>
			</td>
