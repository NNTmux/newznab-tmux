					...
					<tr class="{cycle values=",alt"}">
							...
							<div class="movcover">
								...
								<div class="movextra">
									<div style="text-align: center;">
										...
										<a class="rndbtn badge" href="{$smarty.const.WWW_TOP}/browse/group?g={$mgrp[$m@index]}" title="Browse releases in {$mgrp[$m@index]|replace:"alt.binaries":"a.b"}">Grp</a>
									</div>
								</div>
							</div>
						</td>
						<td colspan="8" class="left" id="guid{$mguid[$m@index]}">
							<ul class="inline">
								...
								{if isset($isadmin)}
									<a class="rndbtn confirm_action btn btn-mini btn-danger pull-right" href="{$smarty.const.WWW_TOP}/admin/release-delete/{$result.releases_id}&amp;from={$smarty.server.REQUEST_URI|escape:"url"}" title="Delete Release">Delete</a>
									<a class="rndbtn btn btn-mini btn-warning pull-right" href="{$smarty.const.WWW_TOP}/admin/release-edit?id={$result.releases_id}&amp;from={$smarty.server.REQUEST_URI|escape:"url"}" title="Edit Release">Edit</a>
								{/if}
							</ul>
