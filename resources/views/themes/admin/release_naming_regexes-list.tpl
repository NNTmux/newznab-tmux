<div class="card">
				    <div class="card-header">
				        <div class="d-flex justify-content-between align-items-center">
				            ...
				            <a href="{{url("/admin/release_naming_regexes-edit")}}" class="btn btn-primary">
				    ...
				    <div class="card-body">
				        <p class="mb-4">This page lists regex used for getting names for releases from usenet subjects.</p>
				        <div id="message"></div>
				            ...
				            <div class="row">
				                <div class="col-md-6 col-lg-4">
				                    <div class="input-group">
				                        ...
				                        <input id="group" type="text" name="group" class="form-control" value="{if isset($group)}{$group}{/if}" placeholder="Search a group...">
				                            ...
				                            <tr id="row-{$row.id}">
				                                ...
				                                <td>
				                                    <div class="btn-group btn-group-sm">
				                                        <a href="{{url("/admin/release_naming_regexes-edit?id={$row.id}")}}" class="btn btn-outline-primary" title="Edit this regex">
				                                            <i class="fa fa-edit"></i>
				                                        </a>
				                                        <a href="javascript:ajax_release_naming_regex_delete({$row.id})"
				...
				function ajax_release_naming_regex_delete(id) {
				    if (confirm('Are you sure you want to delete this regex?')) {
				        fetch(`/admin/release_naming_regexes-delete?id=${id}`, {
				            method: 'POST',
				            headers: {
