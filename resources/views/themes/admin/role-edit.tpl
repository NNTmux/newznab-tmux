<div class="card">
			    ...
			    <div class="card-body">
			        ...
			        <form action="{{url("/admin/role-edit?action=submit")}}" method="post" id="roleEditForm">
			            {{csrf_field()}}
			                    ...
			                    <div class="card mb-4">
			                        ...
			                        <div class="card-body">
			                            ...
			                            <div class="mb-3">
			                                ...
			                                <input type="number" class="form-control" id="defaultinvites" name="defaultinvites" value="{$role.defaultinvites}" min="0">
			                            ...
			                            <div class="mb-3">
			                                ...
			                                <input type="number" class="form-control" id="donation" name="donation" value="{$role.donation}" min="0">
			                                <div class="form-text">Donation amount for this role</div>
			                            </div>

			                            <div class="mb-3">
			                                <label for="addyears" class="form-label fw-bold">Years Added:</label>
			                                <input type="number" class="form-control" id="addyears" name="addyears" value="{$role.addyears}" min="0">
			                            ...
			                            <div class="mb-3">
			                                ...
			                                <div class="form-check">
			                                    <input class="form-check-input" type="radio" name="isdefault" id="isdefault1" value="1" {if $role.isdefault == 1}checked{/if}>
			                                    <label class="form-check-label" for="isdefault1">Yes</label>
			                                </div>
			                                <div class="form-check">
			                                    <input class="form-check-input" type="radio" name="isdefault" id="isdefault0" value="0" {if $role.isdefault == 0}checked{/if}>
			                    ...
			                    <div class="card">
			                        ...
			                        <div class="card-body">
			                            <div class="mb-3">
			                                ...
			                                <div class="form-check">
			                                    <input class="form-check-input" type="radio" name="canpreview" id="canpreview1" value="1" {if $role->hasPermissionTo('preview')}checked{/if}>
			                                    <label class="form-check-label" for="canpreview1">Yes</label>
			                                </div>
			                                <div class="form-check">
			                                    <input class="form-check-input" type="radio" name="canpreview" id="canpreview0" value="0" {if !$role->hasPermissionTo('preview')}checked{/if}>
			                            ...
			                            <div class="mb-3">
			                                ...
			                                <div class="form-check">
			                                    <input class="form-check-input" type="radio" name="hideads" id="hideads1" value="1" {if $role->hasPermissionTo('hideads')}checked{/if}>
			                                    <label class="form-check-label" for="hideads1">Yes</label>
			                                </div>
			                                <div class="form-check">
			                                    <input class="form-check-input" type="radio" name="hideads" id="hideads0" value="0" {if !$role->hasPermissionTo('hideads')}checked{/if}>
			                            ...
			                            <div class="mb-3">
			                                ...
			                                <div class="form-check">
			                                    <input class="form-check-input" type="radio" name="editrelease" id="editrelease1" value="1" {if $role->hasPermissionTo('edit release')}checked{/if}>
			                                    <label class="form-check-label" for="editrelease1">Yes</label>
			                                </div>
			                                <div class="form-check">
			                                    <input class="form-check-input" type="radio" name="editrelease" id="editrelease0" value="0" {if !$role->hasPermissionTo('edit release')}checked{/if}>
			                    ...
			                    <div class="card mb-4">
			                        ...
			                        <div class="card-body">
			                            <div class="mb-3">
			                                ...
			                                <input type="number" class="form-control" id="apirequests" name="apirequests" value="{$role.apirequests}" min="0">
			                            ...
			                            <div class="mb-3">
			                                ...
			                                <input type="number" class="form-control" id="rate_limit" name="rate_limit" value="{$role.rate_limit}" min="0">
			                            ...
			                            <div class="mb-3">
			                                ...
			                                <input type="number" class="form-control" id="downloadrequests" name="downloadrequests" value="{$role.downloadrequests}" min="0">
			                            ...
			                            <div class="row">
			                                <div class="col-md-6">
			                                    <div class="mb-3">
			                                        ...
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewconsole" id="viewconsole1" value="1" {if $role->hasPermissionTo('view console')}checked{/if}>
			                                            <label class="form-check-label" for="viewconsole1">Yes</label>
			                                        </div>
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewconsole" id="viewconsole0" value="0" {if !$role->hasPermissionTo('view console')}checked{/if}>
			                                    ...
			                                    <div class="mb-3">
			                                        ...
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewmovies" id="viewmovies1" value="1" {if $role->hasPermissionTo('view movies')}checked{/if}>
			                                            <label class="form-check-label" for="viewmovies1">Yes</label>
			                                        </div>
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewmovies" id="viewmovies0" value="0" {if !$role->hasPermissionTo('view movies')}checked{/if}>
			                                    ...
			                                    <div class="mb-3">
			                                        ...
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewaudio" id="viewaudio1" value="1" {if $role->hasPermissionTo('view audio')}checked{/if}>
			                                            <label class="form-check-label" for="viewaudio1">Yes</label>
			                                        </div>
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewaudio" id="viewaudio0" value="0" {if !$role->hasPermissionTo('view audio')}checked{/if}>
			                                    ...
			                                    <div class="mb-3">
			                                        ...
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewpc" id="viewpc1" value="1" {if $role->hasPermissionTo('view pc')}checked{/if}>
			                                            <label class="form-check-label" for="viewpc1">Yes</label>
			                                        </div>
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewpc" id="viewpc0" value="0" {if !$role->hasPermissionTo('view pc')}checked{/if}>
			                                ...
			                                <div class="col-md-6">
			                                    <div class="mb-3">
			                                        ...
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewtv" id="viewtv1" value="1" {if $role->hasPermissionTo('view tv')}checked{/if}>
			                                            <label class="form-check-label" for="viewtv1">Yes</label>
			                                        </div>
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewtv" id="viewtv0" value="0" {if !$role->hasPermissionTo('view tv')}checked{/if}>
			                                    ...
			                                    <div class="mb-3">
			                                        ...
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewadult" id="viewadult1" value="1" {if $role->hasPermissionTo('view adult')}checked{/if}>
			                                            <label class="form-check-label" for="viewadult1">Yes</label>
			                                        </div>
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewadult" id="viewadult0" value="0" {if !$role->hasPermissionTo('view adult')}checked{/if}>
			                                    ...
			                                    <div class="mb-3">
			                                        ...
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewbooks" id="viewbooks1" value="1" {if $role->hasPermissionTo('view books')}checked{/if}>
			                                            <label class="form-check-label" for="viewbooks1">Yes</label>
			                                        </div>
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewbooks" id="viewbooks0" value="0" {if !$role->hasPermissionTo('view books')}checked{/if}>
			                                    ...
			                                    <div class="mb-3">
			                                        ...
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewother" id="viewother1" value="1" {if $role->hasPermissionTo('view other')}checked{/if}>
			                                            <label class="form-check-label" for="viewother1">Yes</label>
			                                        </div>
			                                        <div class="form-check">
			                                            <input class="form-check-input" type="radio" name="viewother" id="viewother0" value="0" {if !$role->hasPermissionTo('view other')}checked{/if}>
			    ...
			    <div class="card-footer">
			        <div class="d-flex justify-content-between">
			            ...
			            <button type="submit" form="roleEditForm" class="btn btn-success">
