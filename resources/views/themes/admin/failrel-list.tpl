<div class="card">
				                ...
				                <div class="col-md-6 offset-md-6">
				                    <div class="input-group">
				                        <input type="text" class="form-control" placeholder="Search by name or category"
				                               id="failrelsearch" name="failrelsearch" value="{$lastSearch|escape:'html'}">
				                            ...
				                            <tr>
				                                ...
				                                <td>
				                                    <div class="d-flex align-items-center">
				                                        ...
				                                        <span title="{$release.postdate}">{$release.postdate|date_format}</span>
				                                    </div>
				                                </td>
				                                <td>
				                                    <div class="d-flex align-items-center">
				                                        <i class="fa fa-calendar-plus-o text-muted me-2"></i>
				                                        <span title="{$release.adddate}">{$release.adddate|date_format}</span>
				                                    </div>
				                                </td>
				                                <td class="text-center">
				...
				@media (max-width: 767.98px) {
				    #failrel-search-form .row {
				        margin-right: 0;
				        margin-left: 0;
				    }

				    #failrel-search-form .col-md-6 {
				        padding-right: 0;
				        padding-left: 0;
				    }
				}
