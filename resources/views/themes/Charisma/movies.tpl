							...
							<div class="nzb_multi_operations">
								...
								<div class="btn-group">
									<button type="button"
										...
										<i class="zmdi zmdi-cloud-download"></i></button>
									<button type="button"
									...
									{if isset($sabintegrated) && $sabintegrated !=""}
										<button type="button"
											...
											<i class="zmdi zmdi-share"></i></button>
									{/if}
									{if isset($isadmin)}
										<input type="button"
											...
											<div class="row small-gutter-left">
												<div class="col-md-3 small-gutter-left">
													...
													<a href="{$smarty.const.WWW_TOP}/Movies?imdb={$result->imdbid}"><img
															...
															<i class="zmdi zmdi-exclamation-circle" style="color: red"
														...
														<tr>
															<td id="guid{$mguid[$m@index]}">
																...
																<div>
																	...
																	<i class="zmdi zmdi-thumbs-o-up"></i> {$mgrabs[$m@index]}
																			Grab{if {$mgrabs[$m@index]} != 1}s{/if} / <i
																					class="zmdi zmdi-thumbs-o-down"></i> {$mfailed[$m@index]}
