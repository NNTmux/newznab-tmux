										...
										<div class="panel-body">
											<div class="row small-gutter-left">
												<div class="col-md-3 small-gutter-left">
													...
													{if !empty($result.grp_release_failed)}
														<span class="btn btn-default btn-xs" title="This release has failed to download for some users">
															<i class="zmdi zmdi-thumbs-o-up"></i> {$result.grp_release_grabs} Grab{if {$result.grp_release_grabs} != 1}s{/if} / <i class="zmdi zmdi-thumbs-o-down"></i> {$result.grp_release_failed}Failed Download{if {$result.grp_release_failed} > 1}s{/if}</span>
													{/if}
												</div>
												<div class="col-md-9 small-gutter-left">
													...
													<div id="guid{$result.grp_release_guid}">
														<label>
															<input type="checkbox"
																   class="square"
